...
if(GLFW3_FOUND)
  ...
  if(GLFW3_LIBRARY AND NOT TARGET GLFW::GLFW)
    if(IS_ABSOLUTE "${GLFW3_LIBRARY}")
      add_library(GLFW::GLFW UNKNOWN IMPORTED)
      set_target_properties(GLFW::GLFW PROPERTIES IMPORTED_LOCATION
                            "${GLFW3_LIBRARY}")
    else()
      add_library(GLFW::GLFW INTERFACE IMPORTED)
      set_target_properties(GLFW::GLFW PROPERTIES IMPORTED_LIBNAME
                            "${GLFW3_LIBRARY}")
    endif()
